...
- [ ] Add memory pruning strategy (archive/ + relevance score)
- [ ] Add branch-per-agent conflict resolution doc

## Low Priority
- [ ] Token refresh strategy doc
- [ ] Structured task DAG (queue/pending.json with deps graph)
